...
import { User, ClipboardList, Banknote, Camera, Video, X, Upload, FileVideo, Plus, ArrowLeft, Activity } from "lucide-react";
import { sanitizeFormData, validateFileSize, compressImage, calculatePayloadSize, formatBytes, stripBase64Metadata } from "@/lib/utils-data";
